      ...
      <Panel.Body style={{ backgroundColor: `${upcomingColors[i % 3]}` }} collapsible>
        ...
        <Row>
          <Col xs={12} md={12} lg={12}>
            <MapComponent
              googleMapURL={`https://maps.googleapis.com/maps/api/js?key=${(()=>{alert(process.env.REACT_APP_GOOGLE_MAPS_API_KEY); return process.env.REACT_APP_GOOGLE_MAPS_API_KEY})()}&v=3.exp&libraries=geometry,drawing,places`}
