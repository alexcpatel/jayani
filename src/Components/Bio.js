...
const bioFooterElements = bioFooterLinks =>
...
const bioTextElement = bioFullText =>
  bioFullText.map((snippet, i) => (
    <p key={i} style={{ fontSize: "calc(0.45vw + 0.15vh + 10px)" }}>
      {snippet}
    </p>
  ));
                  ...
                  <Col xs={12} md={12} lg={12}>
                    ...
                    <Jumbotron style={{ backgroundColor: "#5e7fba" }}>
                      <Row>
                        ...
                        <Col xs={12} sm={8} md={9} lg={10}>
                          <p
                            ...
                            style={{
                              fontSize: "calc(0.35vw + 0.15vh + 15px)",
                              textAlign: "left"
                            }}
                          >
                            {data.bio.blurb.text}
                      ...
                      <Row>
                        <Col xs={12} md={12} lg={12}>
                          <em
                            className="blurb-footer"
                            style={{
                              fontSize: "calc(0.35vw + 0.15vh + 15px)",
                              textAlign: "left"
                            }}
                          >
                            {data.bio.blurb.footer}
                          </em>
                        </Col>
                      </Row>
                    </Jumbotron>
                    <Row>
                      <Col xs={12} md={6} lg={8}>
                        <div className="bio-text">{this.bioText}</div>
                      </Col>
                      <Col xs={12} md={6} lg={4}>
                        <Image
                          src={`${process.env.PUBLIC_URL}/data/${
                    ...
                    <div className="bio-footer">{this.footer}</div>
                  </Col>
                </Row>
              </Grid>
            </div>
